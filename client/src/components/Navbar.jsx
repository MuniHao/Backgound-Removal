...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between mx-4 py-3 lg:mx-44'>
      <Link to='/'>
        <img className='w-32 sm:w-44' src={assets.logo} alt='logo pic' />
      </Link>
      ...
      {isSignedIn ? (
        <div className='flex items-center gap-2 sm:gap-3'>
          ...
          >
            <img className='w-5' src={assets.credit_icon} alt='icon pic' />
        ...
        >
          Get started
          <img className='w-3 sm:w-4' src={assets.arrow_icon} alt='icon pic' />
        </button>
      )}
    </div>
  );
